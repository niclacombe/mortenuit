...
<!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>"><img src="<?php echo _IMG_; ?>/enfantscain_logo_white.svg" style="max-height:44px;" alt="Logo"></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <?php if ($this->session->is_logged_in == true && $this->session->user_info->is_confirmed == 1) : ?>
