...
--
-- Table structure for table `missives`
--
...
CREATE TABLE `missives` (
  ...
  `IdGroupeEnvoi` int(11) NOT NULL,
  `IdGroupeReception` int(11) NOT NULL,
...
--
-- Dumping data for table `missives`
--
...
-- Dump completed on 2017-02-26 15:44:27
